...
public class Property {
	...
	public Property(String name, String address, String telephone, String city, double centerDistance,
			String description, int petFriendly, int available, int idu) {
		this.name = name;
	...
	public Property(long id2, String name, String address, String telephone, String city, double centerDistance,
			String description, int petFriendly, int available, int idu) {
		this.id = id2;
		this.name = name;
		this.address = address;
	...
	public boolean equals(Object o) {
		...
		return id == property.id && Objects.equals(name, property.name);
	}
