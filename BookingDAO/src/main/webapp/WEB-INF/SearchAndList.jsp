			...
			<div class="container p-5 pt-0">
				...
				<div class="d-flex row bg-warning busquedaAlojamiento rounded">
					<form class="d-flex" action="ListResultsServlet.do" method="GET">
						<div class="pe-2 pt-2 col-11 form-group">
							<input class="form-control" type="text" id="search" name="search" placeholder="¿Adónde vas?"
								required>
						</div>
				...
				<div class="row ">
					<div class="col m-3 card  shadow rounded">
						<div class="row g-0">
							<div class="col-md-4">
								<img src="img/family.jpeg" class="img-fluid rounded-start imagenOfertas" alt="...">
							</div>
							<div class="col-md-8">
								<div class="card-body">
					...
					<div class="col m-3 card shadow rounded">
						<div class="row g-0">
							<div class="col-md-4">
								<a href="trending.html"> <img src="img/avion.png" class="img-fluid rounded-start"
										alt="...">
								</a>
							</div>
							<div class="col-md-8">
