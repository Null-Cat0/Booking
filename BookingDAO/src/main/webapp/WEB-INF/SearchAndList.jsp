					...
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a href="my_reservations.html" class="dropdown-item">Mis
								reservas</a> 
								<a href="ListPropertiesServlet.do" class="dropdown-item">Mis alojamientos</a>
								<a href="NewPropertyServlet.do" class="dropdown-item">Añadir
								alojamiento</a> 
								<a href="EditUserServlet.do" class="dropdown-item">Perfil</a>
