                    ...
                    <form id="filterForm">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="accommodationType" value="hotel" id="hotelCheckbox">
                                <label class="form-check-label" for="hotelCheckbox">Hotel</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="accommodationType" value="apartment" id="apartmentCheckbox">
                                <label class="form-check-label" for="apartmentCheckbox">Apartamento</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="accommodationType" value="hostel" id="hostelCheckbox">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="rating" value="5" id="5starCheckbox">
                                <label class="form-check-label" for="5starCheckbox">5 estrellas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="rating" value="4" id="4starCheckbox">
                                <label class="form-check-label" for="4starCheckbox">4 estrellas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="rating" value="3" id="3starCheckbox">
                                <label class="form-check-label" for="3starCheckbox">3 estrellas</label>
                            </div>
                        </div>
                        <br>
                    ...
                    <c:forEach var="property" items="${listProperties}">
                        <div class="card mb-3">
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">${property.city} a ${property.centerDistance * 1000} m del centro</p>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="ListPropertyData.do?id=${property.id}" class="btn btn-primary">Ver disponibilidad</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
